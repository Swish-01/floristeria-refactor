...
import com.floristeria.blomst.function.TriConsumer;
import com.floristeria.blomst.security.JwtConfiguration;
...
public class JwtServiceImpl extends JwtConfiguration implements JwtService {
    ...
    private static final String SECRET_BASE64 = "9u3EVrbUvEtJVGOC7xU+wvn1IH9NFj7LNOZcQqHXNNMbsDrVgUoBfOoqWmxqVHr5t4O+6A7Xv3UUs7/No72Z2A==";

    private final Supplier<SecretKey> key = () -> Keys.hmacShaKeyFor(Decoders.BASE64.decode(SECRET_BASE64));
    ...
    @Override
    public void addCookie(HttpServletResponse request, User user, TokenType type) {
        addCookie.accept(request, user, type);
    }
    ...
    @Override
    public void removeCookieKey(HttpServletRequest request, HttpServletResponse response, String cookieName) {
